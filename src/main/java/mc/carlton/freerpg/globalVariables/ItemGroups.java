...
public class ItemGroups {
    ...
    private final double mcVersion = minecraftVersion.getMinecraftVersion_Double();
    ...
    public void initializeTrackedBlocks() {
        ...
        if (mcVersion >= 1.16) {
            ...
            Material[] trackedBlocks_v1_17 = {Material.COPPER_ORE, Material.DEEPSLATE_COAL_ORE,
                    ...
                    Material.DEEPSLATE_REDSTONE_ORE, Material.CALCITE, Material.AMETHYST_BLOCK, Material.AMETHYST_SHARD,
                    Material.LARGE_AMETHYST_BUD, Material.MEDIUM_AMETHYST_BUD, Material.SMALL_AMETHYST_BUD, Material.SMOOTH_BASALT};
            List<Material> trackedBlocks_append = Arrays.asList(trackedBlocks_v1_16);
            List<Material> trackedBlocks_append2 = Arrays.asList(trackedBlocks_v1_17);
            trackedBlocks1.addAll(trackedBlocks_append);
            trackedBlocks1.addAll(trackedBlocks_append2);
        }
    ...
    public void initializeBlocks() {
        ...
        if (mcVersion >= 1.16) {
            ...
            // 1.17.1
            Material[] ores_append1 = {Material.AMETHYST_CLUSTER, Material.COPPER_ORE, Material.DEEPSLATE_COAL_ORE,
                    Material.DEEPSLATE_COPPER_ORE, Material.DEEPSLATE_DIAMOND_ORE, Material.DEEPSLATE_EMERALD_ORE,
                    Material.DEEPSLATE_GOLD_ORE, Material.DEEPSLATE_IRON_ORE, Material.DEEPSLATE_LAPIS_ORE,
                    Material.DEEPSLATE_REDSTONE_ORE, Material.CALCITE, Material.AMETHYST_BLOCK, Material.AMETHYST_SHARD,
                    Material.LARGE_AMETHYST_BUD, Material.MEDIUM_AMETHYST_BUD, Material.SMALL_AMETHYST_BUD, Material.SMOOTH_BASALT};
            List<Material> ores_append = Arrays.asList(ores_append0);
            List<Material> ores_append2 = Arrays.asList(ores_append1);
            ores.addAll(ores_append);
            ores.addAll(ores_append2);
        }
    ...
    public void initializeSmeltableItemsMap() {
        ...
        if (mcVersion >= 1.16) {
            ...
            smeltableItemsMap.put(Material.RAW_COPPER_BLOCK, Material.COPPER_BLOCK);
            smeltableItemsMap.put(Material.RAW_IRON_BLOCK, Material.IRON_BLOCK);
            smeltableItemsMap.put(Material.RAW_GOLD_BLOCK, Material.GOLD_BLOCK);
        }
    ...
    public void initializeSmeltingXPMap() {
        ...
        if (mcVersion >= 1.16) {
            ...
            smeltingXPMap.put(Material.COPPER_ORE, 0.2);
        }
    ...
    public List<PotionEffectType> getHarmfulEffects() {
        return harmfulEffects;
    }

    public List<Material> getLogs() {
        return logs;
    }

    public List<Material> getTallCrops() {
        return tallCrops;
    }

    public Map<Material, Boolean> getTrackedBlocks() {
